...
One great site I found while researching this article is [haveibeenpwned.com][] by Troy Hunt. It'll tell you if you should definitely keep reading.
...
There are three parts to Keepass2 (the password manager) that I'll be referencing in the next section.
...
Keepass2 can be installed on any OS, as can Dropbox. For mobile, I use [keepass2android][] to access my password database file on Dropbox (also installed on the device).
...
### What if I dislike Dropbox?

Check out [Google Drive][]. You can use any cloud storage service that can be on all of your devices and you can treat like a directory.
